...
type BaseModel struct {
	...
	CreatedAt carbon.Carbon   `gorm:"comment:创建时间" json:"created_at"`
	UpdatedAt carbon.Carbon   `gorm:"comment:更新时间" json:"updated_at"`
	DeletedAt CarbonDeletedAt `gorm:"comment:删除时间" json:"deleted_at"`
}
